#include "IPlugWebUIe_SK.h"
#include "IPlug_include_in_plug_src.h"
#include "IPlugPaths.h"

IPlugWebUIe_SK::IPlugWebUIe_SK(const InstanceInfo& info)
...
void IPlugWebUIe_SK::ProcessBlock(sample** inputs, sample** outputs, int nFrames)
{
...
bool IPlugWebUIe_SK::OnMessage(int msgTag, int ctrlTag, int dataSize, const void* pData)
{
...
void IPlugWebUIe_SK::OnParamChange(int paramIdx)
{
  DBGMSG("gain %f\n", GetParam(paramIdx)->Value());
}

void IPlugWebUIe_SK::ProcessMidiMsg(const IMidiMsg& msg)
{
  TRACE;
...
bool IPlugWebUIe_SK::CanNavigateToURL(const char* url)
{
...
bool IPlugWebUIe_SK::OnCanDownloadMIMEType(const char* mimeType)
{
  return std::string_view(mimeType) != "text/html";
}

void IPlugWebUIe_SK::OnDownloadedFile(const char* path)
{
  WDL_String str;
...
void IPlugWebUIe_SK::OnFailedToDownloadFile(const char* path)
{
  WDL_String str;
...
void IPlugWebUIe_SK::OnGetLocalDownloadPathForFile(const char* fileName, WDL_String& localPath)
{
