...
# WIN INSTALLER
  ...
  for line in fileinput.input(projectpath + "/installer/" + config['BUNDLE_NAME'] + ".iss",inplace=1):
    ...
    if "OutputBaseFilename" in line:
      if demo:
        line="OutputBaseFilename=IPlugWebUIe_SK Demo Installer\n"
      else:
        line="OutputBaseFilename=IPlugWebUIe_SK Installer\n"
    ...
    if "WelcomeLabel1" in line:
     if demo:
       line="WelcomeLabel1=Welcome to the IPlugWebUIe_SK Demo installer\n"
     else:
       line="WelcomeLabel1=Welcome to the IPlugWebUIe_SK installer\n"
       
    if "SetupWindowTitle" in line:
     if demo:
       line="SetupWindowTitle=IPlugWebUIe_SK Demo installer\n"
     else:
       line="SetupWindowTitle=IPlugWebUIe_SK installer\n"
