...
# WIN INSTALLER
  ...
  for line in fileinput.input(projectpath + "/installer/" + config['BUNDLE_NAME'] + ".iss",inplace=1):
    ...
    if "OutputBaseFilename" in line:
      if demo:
        line="OutputBaseFilename=IPlugWebUI_SK Demo Installer\n"
      else:
        line="OutputBaseFilename=IPlugWebUI_SK Installer\n"
    ...
    if "WelcomeLabel1" in line:
     if demo:
       line="WelcomeLabel1=Welcome to the IPlugWebUI_SK Demo installer\n"
     else:
       line="WelcomeLabel1=Welcome to the IPlugWebUI_SK installer\n"
       
    if "SetupWindowTitle" in line:
     if demo:
       line="SetupWindowTitle=IPlugWebUI_SK Demo installer\n"
     else:
       line="SetupWindowTitle=IPlugWebUI_SK installer\n"
